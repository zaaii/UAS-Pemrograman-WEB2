					...
					<div class="header__content">
						...
						<div class="header__actions">
							...
							<a href="profile.html" class="header__user">
								...
								{{-- <a class="dropdown-menu header__nav-menu header__nav-menu--scroll" aria-labelledby="profiledd1" href="{{ route('logout') }}" onclick="event.preventDefault();
