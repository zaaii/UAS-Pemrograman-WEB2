                    ...
                    <div class="header__content">
                        ...
                        <ul class="header__nav">
                            <li class="header__nav-item">
                                <a class="header__nav-link" href="{{ url('/home') }}" role="button" id=""
                                    aria-haspopup="true" aria-expanded="false">Home </a>
                            </li>
                            <li class="header__nav-item">
                                <a class="header__nav-link" href="{{ url('/genre') }}" role="button" id=""
                                    aria-haspopup="true" aria-expanded="false">Genre </a>
                            </li>
                            <li class="header__nav-item">
                                <a class="header__nav-link header__nav-link--live" href="{{ url('/live') }}">LIVE<svg
                            ...
                            <li class="header__nav-item">
                                <a class="header__nav-link header__nav-link--more" role="button" id="dropdownMenu3"
                        ...
                        <div class="header__actions">
							...
							@auth
							<a href="{{ url('/profile') }}" class="header__user">
