                ...
                <div class="row row--grid">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="card card--big">
                            <a href="{{ url('/detail') }}" class="card__cover">
                                <img src="images/{{$movie->poster_path}}" alt="{{$movie->original_title}}">
                            ...
                            <div class="card__content">
                                <h3 class="card__title"><a href="{{url('/detail')}}">{{$movie->original_title}}</a></h3>
                                <ul class="card__list">
                                    <li>{{$movie->quality}}</li>
                                    <li>{{$movie->genre}}</li>
                                    <li>{{$movie->release_date}}</li>
                                ...
                                <ul class="card__info">
                                    <li><span>Country:</span><span>{{$movie->country}}</a></span></li>
                                </ul>
                                <p class="card__tagline">{{ Str::limit($movie->overview, 30)}}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="section__title">What's On ZenFlix<b>TV</b></h2>
